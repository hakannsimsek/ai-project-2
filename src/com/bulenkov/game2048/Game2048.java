  ...
  public Game2048() {
    ...
    addKeyListener(new KeyAdapter() {
      ...
      public void keyPressed(KeyEvent e) {
        ...
        //Smoothness: heuristic alone tends to create structures in which adjacent tiles are decreasing in value, but of course in order to merge, adjacent tiles need to be the same value
